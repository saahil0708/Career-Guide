...
const Footer = () => {
    return (
        <footer className="fixed bottom-0 left-0 w-full h-[500px] md:h-[450px] -z-10 bg-[#da2929] text-white flex flex-col items-center justify-center px-4 overflow-hidden">
